...
from keyboards.keyboards import majburiy_obuna, menu
...
async def start(message: Message):
    ...
    await message.answer("Avval kanlimizga obuna bo'ling shundagina botdan to'liq foydalana olasiz!😉", reply_markup=majburiy_obuna)
